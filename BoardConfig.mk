...
# Inherit from common memul-common
-include device/htc/memul-common/BoardConfigCommon.mk
...
# Assert
TARGET_OTA_ASSERT_DEVICE := htc_emul
...
TARGET_LIBINIT_DEFINES_FILE := device/htc/memul/init/init_memul.c
